...
(async()=>{
  ...
  if(E(`typeof MAPS.cavern!=='undefined'`)){
    E(`flags.ch5=true;flags.caveIntro=true;mode='world';B=null;battleUI(false);switchMap('cavern',14,12)`);G.frame(16);shots.push(snap('16-cavern'));
